...
class ResumeMatchingAPI(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            clean = results[["title", "company", "skills", "description", "region", "final_score"]].copy()

            # description max 300 caractères
            clean["description"] = clean["description"].str.slice(0, 300)

            return Response(clean.to_dict(orient="records"))
